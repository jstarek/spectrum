...
\SpecialCoor	%Allow polar co-ordinates (radius,angle) with pstricks
...
% Title font
\newfont{\titlefont}{cmssbx10 at 50pt}
...
% Getting the right black for printing seems to be a bit of a science...
\definecolor{BlackRGB}{rgb}{0 0 0}
% \definecolor{pitchblack}{cmyk}{1 1 1 1}
% \definecolor{Black}{rgb}{0.0001,0.0001,0.0001} %Printer uses this layer as CMYK. For testing, alter the values from 0,0,0.
...
\definecolor{RGBBlackBegin}{cmyk}{1.0 1.0 1.0 1.0}
\definecolor{RGBBlackEnd}{cmyk}{0.9999 0.9999 0.9999 0.9999}


% Applications and frequency usage

\definecolor{HumanAudioColor}{rgb}{0.2,0.2,0.6}
\definecolor{LicenseFreeColor}{rgb}{0.8,0.5,0.1}
\definecolor{BroadcastColour}{rgb}{0.4,0.68,0.86}

% Mobile phone bands
\definecolor{3GBandColor}{rgb}{0 1 0}%Green
\definecolor{4GBandColor}{rgb}{1 0.65 0}%Orange
\definecolor{5GBandColor}{rgb}{0 0.65 1}%Blue
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Special symbols and markings for the chart
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% Vertical infoboxes (called left, but now on right side...? TODO)
\newlength{\nLeftWidth}\setlength{\nLeftWidth}{6.24in}
...
\rput(0, 4.62){
	\psscalebox{0.96}{
		% Sources of EMR line left of poster
		\rput(0.85, 0){\input{sources/sources.tex}}

		% Size comparison line left of poster
		\rput(1.5, 0){\input{sizes/sizes.tex}}

		% Main section of poster
		\rput{0}(3.11, 0){\input{tex/ranges.tex}}
	}
}

% Poster title
\rput[t]{0}(10.1,38.47){
	\titlefont \white Das elektromagnetische Spektrum
}
...
% Decorative right-side sine-wave rainbow
%\rput[b](19.25in,-4.4in){\input{tex/rainbowwave.tex}}
%\rput[b](19.25in,-3.35in){\input{tex/rainbowwave.tex}}
